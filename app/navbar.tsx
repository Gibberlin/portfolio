...
export default function Navbar() {
    ...
    return (
        <div className="p-2 md:p-5 flex flex-row md:flex-col sticky top-0 w-full md:h-screen md:w-1/6 Navbar shadow-lg md:mr-5 bg-gradient-to-r from-blue-500 to-yellow-300 to-green-500">
