...
export default function SocialsPage() {
  ...
  <meta name="twitter:image" content="https://syeds.in/images/preview.png" />
      ...
      <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-3xl mx-auto p-5 md:p-20 bg-emerald-200/70 backdrop-blur-sm border-4 border-emerald-700 dark:bg-slate-950/80 dark:border-emerald-500">
          <h1 className="text-4xl md:text-7xl font-bold text-slate-900 mb-12 border-b-4 border-slate-900 dark:text-emerald-100 dark:border-emerald-400">
            Let&apos;s Connect!
          </h1>
          ...
          <div className="grid gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <a
                ...
                className="flex items-center p-6 bg-slate-900 text-emerald-100 border-4 border-emerald-400 hover:-translate-y-1 transition-transform dark:bg-black dark:border-emerald-300"
              >
