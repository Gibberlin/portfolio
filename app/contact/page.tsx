...
export default function SocialsPage() {
  ...
  <meta name="twitter:image" content="https://syeds.in/images/preview.png" />
      ...
      <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-3xl mx-auto p-5 md:p-20 bg-white/70 dark:bg-[#0F172A]/70 backdrop-blur-md border-4 border-[var(--border-color)]">
          <h1 className="text-4xl md:text-7xl font-bold text-[var(--text-color)] mb-12 border-b-4 border-[var(--border-color)]">
            Let&apos;s Connect!
          </h1>
          ...
          <div className="grid gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <a
                ...
                className="flex items-center p-6 bg-[var(--card-bg)] text-[var(--text-color)] border-4 border-[var(--border-color)] hover:-translate-y-1 transition-transform"
              >
