...
export default function SocialsPage() {
  return (
    <div className="min-h-screen  py-12 px-4 sm:px-6 lg:px-8 w-full">
      <div className="max-w-3xl mx-auto p-5 border-2 border-gray-300 rounded-lg dark:backdrop-brightness-50 backdrop-brightness-200 backdrop-blur-xl">
        ...
        <div className="grid gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <a
              ...
              className="flex items-center p-6 backdrop-brightness-150 dark:backdrop-brightness-50 dark:backdrop-blur-2xl rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
            >
